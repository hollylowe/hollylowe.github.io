      ...
      if (response && response.responseText) {
        try {
          ...
          //         response.responseText);
            error = sweetAlert("Oops...", "Something went wrong!", "error");
        }
      } else {
        // error = new Parse.Error(
  ...
  Parse.Config.get = function(options) {
    ...
    return request.then(function(response) {
      if (!response || !response.params) {
        var errorObject = sweetAlert("Oops...", "Something went wrong!", "error");
...
(function(root) {
  ...
  Parse.Error = function(code, message) {
    this.code = sweetAlert("Oops...", "Something went wrong!", "error");//code;
